...
if __name__ == "__main__":
    ...
    graph_feature_names = ["FDA_APPROVED CT_TOX"] #["Energy"]
    graph_feature_dims = [2]
    ...
    if args.format == "adios":
       ...
       # '''
        ...
        #commenting the lines 294-327 for local set as we dont need samples for smiles data
        '''
        ## Set local set
    ...
    config["NeuralNetwork"]["Variables_of_interest"]["output_dim"] = config["NeuralNetwork"]["Variables_of_interest"]["graph_feature_dims"]
    config["NeuralNetwork"]["Variables_of_interest"]["input_node_features"] = config["NeuralNetwork"]["Variables_of_interest"]["graph_feature_dims"]
    config["Training"] = config["NeuralNetwork"]["Training"]
