...
if __name__ == "__main__":
    ...
    if args.format == "adios":
        ...
        trainset = AdiosDataset(fname, "trainset", comm, **opt, var_config=var_config, keys=common_variable_names)
        valset = AdiosDataset(fname, "valset", comm, **opt, var_config=var_config, keys=common_variable_names)
        testset = AdiosDataset(fname, "testset", comm, **opt, var_config=var_config, keys=common_variable_names)
